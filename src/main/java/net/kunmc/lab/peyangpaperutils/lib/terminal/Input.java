...
public class Input
{
    ...
    {
        if (this.terminal.getSender() instanceof Player)
            return ((Player) this.terminal.getSender()).getUniqueId();
    ...
    public @NotNull Question showYNQuestion(@NotNull String question, @NotNull QuestionAttribute... attributes)
    {
        ...
        return registerInputTask(new Question(this.terminal.getSender(), question, this,
                attrs
        ));
    }
    ...
    public @NotNull Question showYNQuestionCancellable(@NotNull String question, @NotNull QuestionAttribute... attributes)
    {
        ...
        return registerInputTask(new Question(this.terminal.getSender(), question, this, attrs));
    }
    ...
    {
        return registerInputTask(new Question(this.terminal.getSender(), question, this, new AttributeChoice(choices)));
    }
    ...
    {
        return registerInputTask(new Question(this.terminal.getSender(), question, this, attributes));
    }
